...
public class UnistrokeUtils {
 ...
 PACKAGE;
	...
	public class Recognizer {
		...
		public void addTemplate(UnistrokeGesture gesture, List<Vector3D> points, Direction direction)  {
			Templates.add(dollarTemplates.new Template(gesture, points, direction));
			}
